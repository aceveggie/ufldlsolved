...
for imageNum = 1:numImages
    ...
    for channel = 1:imageChannels
      ...
      % ---- YOUR CODE HERE ----
      feature = reshape(Wequ(featureNum, 1+(channel-1)*patchDim*patchDim : ...
                        channel*patchDim*patchDim), patchDim, patchDim);
...
%       feature = flipud(fliplr(squeeze(feature)));
    ...
    % ---- YOUR CODE HERE ----
    convolvedImage = convolvedImage + bequ(featureNum);
